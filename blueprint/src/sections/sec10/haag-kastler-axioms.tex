...
\begin{lemma}[Every Quasilocal Algebra is Covariance-Compatible]
    ...
    \lean{Physicslib4.AQFT.HaagKastler.isCovariantQuasilocal, Physicslib4.AQFT.HaagKastler.isCovariant}
...
\begin{theorem}[Existence of the Quasilocal Lift]
    ...
    \leanok
    For a covariance-compatible quasilocal algebra, the fiberwise Lorentz action extends to a $*$-automorphism of $\mathfrak{U}$, so the lift of \ref{def:quasilocal-lift} exists. By \ref{lmm:quasilocal-covariance-compatible} this hypothesis holds for every quasilocal algebra of a Haag--Kastler net.
\end{theorem}
\begin{proof}
    \leanok
    \uses{def:quasilocal-lift, def:quasilocal-algebra}

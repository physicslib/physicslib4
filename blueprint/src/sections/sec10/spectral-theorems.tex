...
\begin{proof}
    \leanok
    \uses{def:adjoint-bounded, thrm:gelfand-formula, prpstn:resolvent-holomorphy-and-neumann-series, crllr:crllr-1, def:F-class, def:L0-class, def:algebra-of-sets, def:hall-8.6, def:hall-8.8, def:separates-points, def:spectral-radius, lmm:associated-measures-are-finite, lmm:bounded-operators-form-a-banach-space, lmm:hall-7.6, lmm:hall-7.8, lmm:hall-8.1, lmm:hall-ex-8.3.1, lmm:hall-prblm-7.4.8, lmm:hall-prblm-8.3.3a, lmm:hall-prblm-8.3.3b, lmm:hall-prblm-8.3.3c, lmm:lemma-1, lmm:lemma-2, lmm:pointwise-limits-of-borel-measurable-functions, lmm:spectral-mapping-theorem, lmm:spectrum-is-compact-metric-measurable, prpstn:F-bounded, prpstn:F-closed-under-limits, prpstn:F-contains-continuous, prpstn:F-homogeneous, prpstn:F-sesquilinear, prpstn:L0-complement, prpstn:L0-contains-closed, prpstn:L0-contains-empty, prpstn:L0-union, prpstn:bounded-operators-are-continuous, prpstn:cfc-multiplicative, prpstn:cfc-non-negative, prpstn:cfc-norm, prpstn:cfc-self-adjoint, prpstn:cfc-spectral-mapping, prpstn:continuity-of-the-adjoint, prpstn:hall-7.2, prpstn:hall-7.3, prpstn:hall-7.5, prpstn:hall-7.7, prpstn:hall-8.3, prpstn:hall-8.4, prpstn:hall-8.7, prpstn:hall-a.34, prpstn:hall-a.62, thrm:analytic-equivalence-theorem, thrm:archimedean-property, thrm:bounded-convergence-theorem, thrm:bounded-linear-transformation-theorem, thrm:boundedness-theorem, thrm:complex-valued-simple-approximation-theorem, thrm:composition-theorem, thrm:existence-of-bump-functions, thrm:fundamental-theorem-of-algebra, thrm:maximum-modulus-principle, thrm:monotone-class-theorem, thrm:monotone-convergence-theorem-nonincreasing, thrm:riesz-representation, def:identity-operator, def:indicator-function, def:orthogonal-complement, prpstn:basic-integral-properties, def:bounded-operator-notation, def:projection-valued-measure, def:bounded-operator-resolvent-and-spectrum, def:bounded-orthogonal-projection, thrm:operator-valued-integration, thrm:hall-8.10, thrm:hall-prblm-8.3.4}

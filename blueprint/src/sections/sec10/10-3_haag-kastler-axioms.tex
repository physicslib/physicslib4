...
\begin{theorem}[Positive-Energy API]
    ...
    \lean{Physicslib4.AQFT.HaagKastler.isPositiveEnergy_const_refl, Physicslib4.AQFT.HaagKastler.exp_generator_unique, Physicslib4.AQFT.HaagKastler.IsPositiveEnergy.conj}
    \leanfile{Physicslib4/AQFT/HaagKastler/VacuumState.lean}
    \leanok

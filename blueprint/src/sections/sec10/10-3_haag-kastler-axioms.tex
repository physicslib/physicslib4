...
The converse, irreducible $\Rightarrow$ pure, requires the other half of the GNS Radon-Nikodym correspondence: that \emph{every} dominated positive functional $\psi \le \omega$ arises as $\psi(a) = \langle \Omega, T\,\pi(a)\Omega\rangle$ for some $0 \le T \le 1$ in the commutant. That surjectivity (a bounded sesquilinear-form extension) is a separate analytic development.

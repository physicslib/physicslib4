...
\begin{proof}
    \leanok
    \uses{thrm:irreducible-generates-all}
    This is the bundled counterpart of \ref{thrm:irreducible-generates-all}.
\end{proof}
...
\begin{proof}
    ...
    The underlying set is a von Neumann algebra because $\pi(A)$ is self-adjoint and a commutant is always a von Neumann algebra since $S''' = S'$; membership unfolds to being a self-intertwiner of $\pi$, and the triviality criterion is \ref{lmm:endomorphism-scalar}.
\end{proof}

...
\begin{definition}[Spacetime]
    ...
    \begin{align}
        \mathtt{ContMDiff}\;I\;\Big(I.\mathtt{prod}\;\mathcal{I}\big(\mathbb{R},\, E \to_L[\mathbb{R}] E \to_L[\mathbb{R}] \mathbb{R}\big)\Big)\;\infty\;\Big(x \mapsto \mathtt{Bundle.TotalSpace.mk'}\;\big(E \to_L[\mathbb{R}] E \to_L[\mathbb{R}] \mathbb{R}\big)\;x\;(g_x)\Big),
    \end{align}
...
\begin{proof}
    ...
    This lemma is already formalized, as \texttt{Physicslib4.Spacetime.alexandrovBasis\_directed}, and so are the two point-existence helpers it consumes, \texttt{exists\_common\_past} and \texttt{exists\_common\_future}.
\end{proof}
...
\begin{lemma}[The Pullback Metric is a Smooth Section of the Bilinear-Form Bundle]
    ...
    \begin{align}
        \mathtt{ContMDiff}\;I\;\Big(I.\mathtt{prod}\;\mathcal{I}\big(\mathbb{R},\, E \to_L[\mathbb{R}] E \to_L[\mathbb{R}] \mathbb{R}\big)\Big)\;\infty\;\Big(x \mapsto \mathtt{Bundle.TotalSpace.mk'}\;\big(E \to_L[\mathbb{R}] E \to_L[\mathbb{R}] \mathbb{R}\big)\;x\;\big((\psi^*g)_x\big)\Big).
    \end{align}
...
\begin{proof}
    ...
    \emph{The route, now pinned down.} This was previously recorded as an open API question. It is no longer open: every smoothness step is supplied by Mathlib, and what remains is two mechanical local identities. The chain is:
    \begin{itemize}

...
\begin{align}
    \|\pi_\omega(a)[z]\|^2 &= \|[az]\|^2 \\
                           ...
                           &= \omega((az)^*(az)) \\
                           &= \omega(z^\textit{(a^}a)z) \\
                           &= \frac{\omega(z^\textit{(a^}a)z)}{\omega(z^*z)} \omega(z^*z) \\
                           &= \frac{\omega(z^\textit{(a^}a)z)}{\omega(z^*z)} \|[z]\|^2.
\end{align}
...
\begin{align}
    \phi(c^*c) = \frac{\omega(z^\textit{(c^}c)z)}{\omega(z^*z)} = \frac{\omega((cz)^*(cz))}{\omega(z^*z)} \ge 0
\end{align}
